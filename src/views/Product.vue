...
export default {
  ...
  components: {
    ...
    carousel
      ...
      return {
          photo:"img/products/black-coach 1.jpg",
          thumbs:[
              "img/products/black-coach 1.jpg",
              "img/products/black-coach 2.jpg",
              "img/products/black-coach 3.jpg",
              "img/products/black-coach 4.jpg",
          ]
      }
  },methods:{
